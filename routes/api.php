...
Route::middleware('auth:sanctum')->group(function (){
    ...
    Route::post('add-favourite',[\App\Http\Controllers\ProjectController::class,'addFavourite']);
    Route::post('remove-favourite',[\App\Http\Controllers\ProjectController::class,'removeFavourite']);
    Route::post('favourite-list',[\App\Http\Controllers\ProjectController::class,'getFavouriteList']);
