...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="">Shopno Neer</a>
    <!-- Sidebar Toggle-->
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">@section('title')@show</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item">@section('bread_controller')@show</li>
                    <li class="breadcrumb-item active">@section('bread_action')@show</li>
                </ol>
                @yield('content')
            </div>
        </main>
