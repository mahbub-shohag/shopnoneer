@php
    ...
    use Illuminate\Support\Facades\Route;  // Ensure Route is imported
@endphp

<?php
function active($selectedMenu) {
    // Get the current route name (without action part)
    $menu = strtok(Route::current()->getName(), ".");
    return $menu == $selectedMenu ? 'active' : '';
}

function isActiveCollapse($selectedMenu) {
    // Get the current route name (without action part)
    $menu = strtok(Route::current()->getName(), ".");
    return $menu == $selectedMenu ? 'show' : '';
}
?>
    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <!-- SETUP -->
                <a class="nav-link {{ active('setup') }}" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="{{ (active('setup') ? 'true' : 'false') }}" aria-controls="collapseLayouts">
                    <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                    SETUP
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="show collapse {{ isActiveCollapse('setup') }}" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                ...
                <div class="collapse {{ isActiveCollapse('project') }}" id="collapseProject" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                ...
                <div class="collapse {{ isActiveCollapse('profile') }}" id="collapseProfile" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
